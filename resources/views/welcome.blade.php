            ...
            <div class="row bg-light" >
                    ...
                    <div class="col-md-6 d-flex align-items-center justify-content-center">
                        <div class="col-10 col-lg-8 m-3">
                            ...
                            <p class="text-justify">Cette application web Cartable, dans sa première version permet à Léo-Paul, son créateur, de référencer des vidéos qui lui ont permis d'acquérir de nouvelles compétences techniques dans différents domaines (vidéo, photo, communication, développement web) ainsi qu'à enrichir sa culture sur ces sujets.
                                <br>
                                <br>
